        ...
        <div className="flex gap-4 mb-6 clay-card p-4 rounded-2xl">
            <div className="flex-1 flex flex-col items-center">
                <div className="flex items-center gap-1.5 text-slate-400 dark:text-[#888] mb-1">
                    <BookOpen size={12} />
                    <span className="text-[10px] font-medium uppercase tracking-wide">今日新词</span>
                </div>
            ...
            <div className="flex-1 flex flex-col items-center">
                <div className="flex items-center gap-1.5 text-slate-400 dark:text-[#888] mb-1">
                    <RefreshCw size={12} />
                    <span className="text-[10px] font-medium uppercase tracking-wide">今日复习</span>
                </div>
            ...
            <div className="flex-1 flex flex-col items-center">
                <div className="flex items-center gap-1.5 text-slate-400 dark:text-[#888] mb-1">
                    ...
                    <span className="text-[10px] font-medium uppercase tracking-wide">顽固词</span>
                </div>
